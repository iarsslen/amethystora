...
7. `08-firmware.sh` - Firmware configurations
8. `17-cleanup.sh` - Cleanup operations
9. `18-workarounds.sh` - Temporary fixes/workarounds
10. `19-initramfs.sh` - Regenerates initramfs
